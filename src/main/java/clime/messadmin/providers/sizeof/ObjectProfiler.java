...
public abstract class ObjectProfiler {
	...
	static {
		...
		classesSizes.put("java.lang.Class", Integers.valueOf(0));//not really a pb, but since this is shared, so there's no point in going further
		// 1.3+
		...
		// 1.5+
		classesSizes.put("java.lang.Enum", Integers.valueOf(0));//not really a pb, but since this is shared, so there's no point in going further
